                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-8 gap-4 flex flex-row items-end">
                        <div class="col-span-4 lg:col-span-2">
                            <InputLabel for="beerName" value="Name" />
                            <TextInput placeholder="Name of the beer" id="beerName" type="text" class="mt-1 block w-full" v-model="form.beerName" />
                        </div>
                        ...
                        <div class="col-span-4 lg:col-span-1">
                            <InputLabel for="ibuGt" value="IBU" />
                            <TextInput id="ibuGt" type="text" class="mt-1 block w-full" v-model="form.ibuGt" />
                        </div>
                        <div class="col-span-4 lg:col-span-2">
